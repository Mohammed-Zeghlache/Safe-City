...
const Header4 = () => {
  ...
  return (
    <header className={`sc-header ${scrolled ? 'sc-scrolled' : ''}`}>
      <div className="sc-header-content">
        ...
        <button className="sc-nav-item" onClick={() => handleNavigation('/')}>
            <span>Home</span>
          </button>
  ...
  onClick={() => handleNavigation('/carte')}
  style={{
  ...
  <span style={{
    ...
    borderRadius: '2px'
        ...
        <div className="sc-auth-buttons">
          <button className="sc-signin-btn" onClick={() => handleNavigation('/signup')}>
            Sign In
          </button>
          <button className="sc-getstarted-btn" onClick={() => handleNavigation('/signup')}>
            Get Started
          </button>
        </div>
